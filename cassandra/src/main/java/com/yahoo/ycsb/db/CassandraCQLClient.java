 ...
 * 
 * In CQLSH, create keyspace and table. Something like: cqlsh> create keyspace ycsb WITH REPLICATION = {'class' :
 * 'SimpleStrategy', 'replication_factor': 1 }; cqlsh> create table usertable ( y_id varchar primary key, field0
 * varchar, field1 varchar, field2 varchar, field3 varchar, field4 varchar, field5 varchar, field6 varchar, field7
...
public class CassandraCQLClient extends DB
{
     ...
     * in a HashMap.
     * 
     * Cassandra CQL uses "token" method for range scan which doesn't always yield intuitive results.
     *
     * @param table
     *            The name of the table
     * @param startkey
